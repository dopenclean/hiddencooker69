...
function checkAuthSession() {
    ...
    return (authCookie === null || authCookie === void 0 ? void 0 : authCookie.includes('authenticated')) || false;
}
...
function getSessionTimeRemaining() {
    ...
    const cookies = document.cookie.split(';');
    const authCookie = cookies.find((cookie)=>cookie.trim().startsWith('auth_session='));
    if (!(authCookie === null || authCookie === void 0 ? void 0 : authCookie.includes('authenticated'))) return 0;
...
function AutomationPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AutomationPage.useEffect": ()=>{
            const checkAuth = {
                "AutomationPage.useEffect.checkAuth": ()=>{
                    const isValid = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$utils$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["checkAuthSession"])();
            ...
            return ({
                "AutomationPage.useEffect": ()=>clearInterval(authInterval)
            })["AutomationPage.useEffect"];
        }
    }["AutomationPage.useEffect"], [
        router
    ...
    // Logout function
    const handleLogout = ()=>{
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$utils$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["clearAuthSession"])();
        router.push('/');
    };
    const renderStep = ()=>{
        switch(currentStep){
...
_s(AutomationPage, "plt3/Y7MB8TxQQqAjyJ2d6S8k8c=", false, function() {
    return [
...
//# sourceMappingURL=src_app_0937a050._.js.map